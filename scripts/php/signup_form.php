...
// 		$mailto = ''; # Live/Production
		$mailfrom = "FROM: Guzman23Foundation.com <info@guzman23foundation.com>";
		$mailsubject = "[Guzman23Foundation.com] Information Request";
		$mailbody = ucfirst(strtolower($fname)) . " would like to receive more information about the Guzman23Foundation." . "\n";
		$mailbody .= "--------------------------------\n";
